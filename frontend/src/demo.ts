...
export const scenario = [
  ...
  { speaker: 'Assistant', text: 'We can talk naturally. Calculations and project questions go to a separate worker.', gap: 240 },
  { speaker: 'You', text: 'Calculate (120 + 80) * 1.22.', gap: null },
  { speaker: 'Assistant', text: 'Simulated worker result: 244. The real offline worker is available from the command line.', gap: 310 },
] as const;
